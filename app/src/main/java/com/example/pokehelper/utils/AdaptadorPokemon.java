...
public class AdaptadorPokemon extends RecyclerView.Adapter<AdaptadorPokemon.ViewHolderPokes> implements View.OnClickListener{
    private List<Pokemon> datos;
    private View.OnClickListener listener;

    public AdaptadorPokemon(List<Pokemon> datos){
        this.datos = datos;
    }
    ...
    public void onBindViewHolder(@NonNull ViewHolderPokes holder, int position) {
        Pokemon items = datos.get(position);
    ...
    public class ViewHolderPokes extends RecyclerView.ViewHolder {
        ...
        public void bindTitular(Pokemon p){
